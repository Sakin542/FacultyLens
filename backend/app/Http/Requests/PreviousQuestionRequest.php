...
class PreviousQuestionRequest extends FormRequest
{
    ...
    {
        return [
            'question_text' => 'nullable|string|required_without:file|max:5000',
            'question_type' => 'nullable|string|in:mcq,short_answer,descriptive,problem_solving,true_false,other',
            'marks' => 'nullable|numeric|min:0|max:1000',
            'difficulty_level' => 'nullable|string|in:easy,medium,hard',
            'cognitive_level' => 'nullable|string|in:Remember,Understand,Apply,Analyze,Evaluate,Create',
