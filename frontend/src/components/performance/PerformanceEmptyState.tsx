...
export const PerformanceEmptyState: React.FC<PerformanceEmptyStateProps> = ({ meta, onAnalyze, isAnalyzing = false }) => {
  ...
  return (
    <div className="p-6 rounded-xl border border-dashed border-sage-200 dark:border-[#3A3A3C] bg-white dark:bg-[#1C1C1E] text-center space-y-3" data-testid="performance-empty">
      <div className="w-10 h-10 rounded-lg bg-sage-100 dark:bg-[#2C2C2E] flex items-center justify-center mx-auto">
        <BarChart3 className="w-5 h-5 text-sage-500" />
      </div>
      <div className="space-y-1">
        <h4 className="text-sm font-bold text-sage-800 dark:text-white">No performance analysis yet</h4>
