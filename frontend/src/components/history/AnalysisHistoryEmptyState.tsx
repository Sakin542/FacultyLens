...
export const AnalysisHistoryEmptyState: React.FC<AnalysisHistoryEmptyStateProps> = ({
  ...
  return (
    <Card className="p-12 text-center bg-white dark:bg-[#1C1C1E] border border-sage-200 dark:border-[#2C2C2E] shadow-sm space-y-4 max-w-lg mx-auto">
      <div className="w-14 h-14 rounded-2xl bg-sage-100 dark:bg-[#2C2C2E] border border-sage-200 dark:border-[#3A3A3C] flex items-center justify-center mx-auto text-sage-500">
      ...
      <div className="pt-2 flex items-center justify-center gap-3">
        {hasFilters && onClearFilters ? (
          ...
          <Button
            ...
            className="bg-sage-700 dark:bg-white text-white dark:text-sage-800"
          >
            Go to Assessments
