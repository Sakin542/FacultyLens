    ...
    <Card className="p-5 bg-white dark:bg-[#1C1C1E] border border-[#E5E5E5] dark:border-[#2C2C2E] shadow-sm space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-[#E5E5E5] dark:border-[#2C2C2E]">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-[#111111] dark:text-white">Topic Coverage</h3>
            <p className="text-xs text-[#737373]">Identified course topics evaluated in questions</p>
          </div>
        </div>

        <div className="text-right">
          <span className="text-xs text-[#737373] block">Coverage</span>
          ...
          {topics.map((item, idx) => (
            ...
            >
              <div className="min-w-0 flex-1">
                <span className="font-semibold text-[#111111] dark:text-white block truncate">
                  {item.topic}
                </span>
