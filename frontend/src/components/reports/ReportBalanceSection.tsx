  ...
  return (
    <div className="bg-white border border-[#E5E5E5] rounded-xl p-6 mb-6 shadow-subtle">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="border border-[#EBEBEB] rounded-lg p-4 bg-[#FAFAFA]">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-[#111111]">
              Difficulty Distribution (Marks Basis)
            </h4>
            <span className="text-xs font-semibold text-[#111111] bg-white px-2 py-0.5 rounded border border-[#E5E5E5]">
              Score: {Math.round(difficulty.score * 10) / 10}%
            </span>
          </div>

          <table className="w-full text-left text-xs border-collapse">
            <thead className="border-b border-[#E5E5E5] text-[#525252] font-medium">
              <tr>
            ...
            <tbody className="divide-y divide-[#EEEEEE]">
              {diffLevels.map((tier, idx) => (
                <tr key={idx}>
                  ...
                  <td className="py-2.5 text-center font-mono text-[#525252]">
                    {tier.question_count}
                  </td>
                  <td className="py-2.5 text-center font-mono text-[#111111]">
                    {tier.marks}
                  </td>
                  <td className="py-2.5 text-center font-bold text-[#111111]">
                    {tier.actual_percentage}%
                  </td>
                  <td className="py-2.5 text-center text-[#737373] font-mono">
          ...
          <div className="mt-4 pt-3 border-t border-[#EBEBEB]">
            <div className="text-[11px] text-[#737373] mb-1.5 flex justify-between">
        ...
        <div className="border border-[#EBEBEB] rounded-lg p-4 bg-[#FAFAFA]">
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-[#EEEEEE]">
              {bloomLevels.map((bloom, bIdx) => (
                <tr key={bIdx}>
                  <td className="py-2 font-semibold text-[#111111]">
                    {bloom.label}
                  </td>
                  <td className="py-2 text-center font-mono text-[#525252]">
                    {bloom.count}
                  </td>
                  <td className="py-2 text-center font-mono text-[#111111]">
                    {bloom.marks}
                  </td>
                  <td className="py-2 text-center font-bold text-[#111111]">
                    {bloom.percentage}%
                  </td>
                </tr>
              ))}
          ...
          <p className="text-[11px] text-[#737373] mt-4 pt-3 border-t border-[#EBEBEB] leading-relaxed">
